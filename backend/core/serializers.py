...
class ExamAttemptSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ExamAttempt
        fields = ['id', 'user', 'course', 'course_name', 'topic', 'topic_name', 'exam_type', 'score', 'correct_count', 'total_questions', 'created_at']
...
class ExamAttemptAnswerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'question', 'question_statement', 'selected_option', 'selected_option_text', 'is_correct', 'correct_option_text']
