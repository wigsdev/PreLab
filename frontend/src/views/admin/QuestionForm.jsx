    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-8 pb-24">
            ...
            <form
                ...
                className="space-y-6 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm"
            >
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid gap-3">
                        {formData.options.map((opt, idx) => (
                            <div
                                key={idx}
                                className={`group flex items-center gap-3 p-2 rounded-xl border-2 transition-all ${opt.is_correct ? 'border-green-500 bg-green-50/50 dark:bg-green-900/10' : 'border-transparent hover:border-slate-200 dark:hover:border-slate-700'}`}
                            >
                                <button
                                    type="button"
