    ...
    return (
        <div className="w-full max-w-2xl mx-auto py-8 px-4 animate-in fade-in duration-500">
            <header className="mb-8 text-center">
                ...
                <p className="text-slate-500 mt-2">Repasa tus respuestas y aprende de los errores.</p>
            </header>
                    ...
                    return (
                        <div key={question.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            ...
                            <div className={clsx(
                                ...
                                wasCorrect ? "bg-green-50 border-green-100" : "bg-red-50 border-red-100"
                            )}>
                                <div className={clsx(
                            ...
                            <div className="p-6 space-y-3 bg-white">
                                {question.options.map(opt => {
                                    ...
                                    return (
                                        <div key={opt.id} className={clsx("p-3 rounded-lg border flex items-center", style)}>
