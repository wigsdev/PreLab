                ...
                <div className="p-4">
                    {status === 'success' ? (
                        <div className="text-center py-8">
                            ...
                            <h4 className="font-bold text-slate-800 dark:text-white mb-2">¡Gracias por avisarnos!</h4>
                            <p className="text-sm text-slate-500">Revisaremos tu reporte lo antes posible.</p>
                        </div>
                    ) : (
                        <form onSubmit={handleSubmit}>
                            <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                                ¿Qué problema encontraste en esta pregunta? Tu feedback nos ayuda a mejorar.
                            </p>
                            ...
                            <div className="mt-4 flex justify-end gap-2">
                                ...
                                >
                                    {status === 'submitting' ? <Loader2 className="animate-spin" size={16} /> : 'Enviar Reporte'}
                                </button>
                            </div>
                        </form>
                    )}
